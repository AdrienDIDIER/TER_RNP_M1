...
project_name = 'mnist_3layers_012_345_disc'
train_values = [0,1,2]
test_values=[3,4,5]
...
print("\n\n\n============ DISCRETISATION DES SIGNATURES D'APPRENTISSAGE ========")

discretized_training_signatures, nbs_bins = discretisation.discretize_training_signatures(512, project_name = project_name)
...
clusterisation.clusterize_test_signatures(discretized_test_signatures, layers_kmeans, test_values, project_name)


print("\n\n\n============ GENERATION DES DONNEES POUR L'INTERFACE ========")

misc.generate_interface_data(project_name, model, clusterized_discretized_training_signatures)
